    ...
    <section className="flex flex-col w-full items-center pb-28">
      ...
      <form className="w-full text-center" onSubmit={handleSubmit}>
        <div className="fixed bottom-0 w-full bg-transparent backdrop-blur-md">
          <input
            className="py-4 px-4 mb-4 w-full bg-transparent max-w-xl border border-white rounded-full outline-none focus:ring-1 placeholder-slate-700 focus:ring-blue-50"
            value={input}
